     ...
     bottomNavigationBar: BottomAppBar(
       ...
       appBar: AppBar(
        ...
        Row(
          children: [
            Container(
               child: Text("Reality Club", style: GoogleFonts.radioCanada(
        ...
        child: Column(
          children: [
            ...
            items: [
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  image: DecorationImage(image: AssetImage('assets/images/rc3app.jpg')) ,
                ),
              ),
              Container(
              //  child: Image.asset('assets/images/rc10app.jpeg', ),
                decoration: BoxDecoration(
                  ...
                  borderRadius: BorderRadius.circular(30),
                   image: DecorationImage(image: AssetImage('assets/images/rc10app.jpeg')) ,
                ),
              ),
              Container(
                // child: Image.asset('assets/images/rccapp.jpg'),
                 decoration: BoxDecoration(
                  borderRadius: BorderRadius.circular(30),
                   image: DecorationImage(image: AssetImage('assets/images/rccapp.jpg')) ,
                ),
              ),
            ]
            ),
           ...
           Row(
                      ...
                      child: Column(
                        children: [
                          Padding(
                            ...
                            child: Image.asset('assets/images/shirt3.png', height: 40, width:40),
                          ),
                          Text("Merch", style: GoogleFonts.candal(
                          textStyle: Theme.of(context).textTheme.displayLarge,
                        fontSize: 15, 
                        color: Color.fromRGBO(202, 31, 31, 1) ,
                        ),)
                     ...
                     child: Container( 
                      ...
                      child: Column(
                        children: [
                          Padding(
                            padding: const EdgeInsets.only(top: 7,bottom: 5 ),
                            child: Image.asset('assets/images/ticket3.png', height: 40, width:40),
                          ),
                          Text("Ticket", style: GoogleFonts.candal(
                          textStyle: Theme.of(context).textTheme.displayLarge,
                        fontSize: 15, 
                        color: Color.fromRGBO(202, 31, 31, 1) ,
                        ),)
                ...
                Container(
                  child:  Text('Upcoming!', style:  GoogleFonts.viga(
                          textStyle: Theme.of(context).textTheme.displayLarge,
                        fontSize: 20, 
                        color: Colors.black
                        ),),
